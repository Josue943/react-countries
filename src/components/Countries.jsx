...
export default class Countries extends Component {
  ...
  async componentDidMount(){
    ...
    getPagedData= () =>{
        const {currentPage,pageSize,countries:allCountries,selectedRegion,searchQuery} = this.state
        ...
        return (
            ...
            <div className="countries-list">      
                <div className="search">
                    <Searchbox
                    value={searchQuery}
                    onChance={this.handleSearch}
                    />
                    <Select onChanceRegion={this.handleRegionSelect}
                     options={regions} />
                </div>
